                ...
                <div>
                    <div className="group perspective cursor-pointer bg-secondary" key={i}>
                        <div className="relative preserve-3d group-hover:my-rotate-y-180 duration-700 aspect-h-4 aspect-w-3">
                            ...
                            <div className="absolute my-rotate-y-180 backface-hidden bg-fourth rounded-lg overflow-hidden p-3 h-full w-full">
                                <div className="text-center flex flex-col items-center bg-third justify-center text-gray-800 h-full w-full">
